!(function (e, t) {
  ...
  return (function (e) {
        ...
        var P = function (e, t) {
          ...
          E = function (e) {
            ...
            return new Promise(function (e, i) {
              p("[".concat(t, "]: Start ").concat(r, ", action=").concat(n)), P(n, e), S(n, i), O(k, { workerId: t, jobId: r, action: n, payload: o });
            });
          },
          L = function (e) {
          ...
          T = function (e, t, r) {
            return E(l({ id: r, action: "FS", payload: { method: "writeFile", args: [e, t] } }));
          },
          R = function (e, t) {
            return E(l({ id: t, action: "FS", payload: { method: "readFile", args: [e, { encoding: "utf8" }] } }));
          },
          _ = function (e, t) {
            return E(l({ id: t, action: "FS", payload: { method: "unlink", args: [e] } }));
          },
          A = function (e, t, r) {
            return E(l({ id: r, action: "FS", payload: { method: e, args: t } }));
          },
          D = function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "eng",
              t = arguments.length > 1 ? arguments[1] : void 0;
            return E(l({ id: t, action: "loadLanguage", payload: { langs: e, options: c } }));
          },
          N = function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "eng",
              t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : h,
              r = arguments.length > 2 ? arguments[2] : void 0;
            return E(l({ id: r, action: "initialize", payload: { langs: e, oem: t } }));
          },
          F = function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
              t = arguments.length > 1 ? arguments[1] : void 0;
            return E(l({ id: t, action: "setParameters", payload: { params: e } }));
          },
          I = (function () {
            var e = o(
                ...
                return regeneratorRuntime.wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (r = o.length > 1 && void 0 !== o[1] ? o[1] : {}), (n = o.length > 2 ? o[2] : void 0), (e.t0 = E), (e.t1 = l), (e.t2 = n), (e.next = 7), w(t);
                      case 7:
                        return (
                          (e.t3 = e.sent),
                          (e.t4 = r),
                          (e.t5 = { image: e.t3, options: e.t4 }),
                          (e.t6 = { id: e.t2, action: "recognize", payload: e.t5 }),
                          (e.t7 = (0, e.t1)(e.t6)),
          ...
          M = function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "Tesseract OCR Result",
              ...
              r = arguments.length > 2 ? arguments[2] : void 0;
            return E(l({ id: r, action: "getPDF", payload: { title: e, textonly: t } }));
          },
          C = (function () {
            var e = o(
              regeneratorRuntime.mark(function e(t, r) {
                return regeneratorRuntime.wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (e.t0 = E), (e.t1 = l), (e.t2 = r), (e.next = 5), w(t);
                      case 5:
                        return (e.t3 = e.sent), (e.t4 = { image: e.t3 }), (e.t5 = { id: e.t2, action: "detect", payload: e.t4 }), (e.t6 = (0, e.t1)(e.t5)), e.abrupt("return", (0, e.t0)(e.t6));
                      case 10:
                      case "end":
                        return e.stop();
                    }
              ...
              regeneratorRuntime.mark(function e() {
                return regeneratorRuntime.wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return null !== k && (v(k), (k = null)), e.abrupt("return", Promise.resolve());
                      case 2:
                      case "end":
                        return e.stop();
                    }
        ...
        return (
          m(k, function (e) {
            ...
            if ("resolve" === o) {
              ...
              var s = u;
              "recognize" === c ? (s = f(u)) : "getPDF" === c && (s = Array.from(a({}, u, { length: Object.keys(u).length }))), y[c]({ jobId: r, data: s });
            } else if ("reject" === o) {
    ...
    function (e, t) {
      e.exports = { TESSERACT_ONLY: 0, LSTM_ONLY: 1, TESSERACT_LSTM_COMBINED: 2, DEFAULT: 3 };
    },
    function (e, t, r) {
      function n(e, t) {
        var r = Object.keys(e);
      ...
      e.exports = (function (e) {
        ...
        return e;
      })({ OEM: u, PSM: s, createScheduler: i, createWorker: a, setLogging: f }, c);
    },
    function (e, t, r) {
      (function (e) {
        function t(e) {
        ...
        var r = (function (e) {
          ...
          function P(e, t) {
            ...
            if (n === r) {
              if (((t.delegate = null), "throw" === t.method)) {
                if (e.iterator.return && ((t.method = "return"), (t.arg = r), P(e, t), "throw" === t.method)) return y;
            ...
            return i
              ? i.done
                ? ((t[e.resultName] = i.value), (t.next = e.nextLoc), "return" !== t.method && ((t.method = "next"), (t.arg = r)), (t.delegate = null), y)
                : i
              : ((t.method = "throw"), (t.arg = new TypeError("iterator result is not an object")), (t.delegate = null), y);
          }
          function S(e) {
            var t = { tryLoc: e[0] };
          ...
          return (
            ...
            (e.mark = function (e) {
              return Object.setPrototypeOf ? Object.setPrototypeOf(e, v) : ((e.__proto__ = v), u in e || (e[u] = "GeneratorFunction")), (e.prototype = Object.create(j)), e;
            }),
            (e.awrap = function (e) {
              return { __await: e };
            }),
            ...
            (L.prototype = {
              ...
              dispatchException: function (e) {
                ...
                var t = this;
                function n(n, o) {
                  return (c.type = "throw"), (c.arg = e), (t.next = n), o && ((t.method = "next"), (t.arg = r)), !!o;
                }
              ...
              finish: function (e) {
                for (var t = this.tryEntries.length - 1; t >= 0; --t) {
                  ...
                  if (r.finallyLoc === e) return this.complete(r.completion, r.afterLoc), E(r), y;
                }
              },
              catch: function (e) {
                for (var t = this.tryEntries.length - 1; t >= 0; --t) {
              ...
              delegateYield: function (e, t, n) {
                return (this.delegate = { iterator: T(e), resultName: t, nextLoc: n }), "next" === this.method && (this.arg = r), y;
              },
            }),
            e
          );
      ...
      e.exports = function () {
                      ...
                      return regeneratorRuntime.wrap(
                        function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              case 0:
                                return i.shift(), (r[a.id] = d), (e.prev = 2), (e.t0 = f), (e.next = 6), a[t].apply(n, [].concat(o(s), [d.id]));
                              case 6:
        ...
        return {
          addWorker: function (r) {
            return (t[r.id] = r), u("[".concat(e, "]: Add ").concat(r.id)), u("[".concat(e, "]: Number of workers=").concat(l())), p(), r.id;
          },
          addJob: (function () {
            var t = a(
        ...
        e.exports = function (e) {
          ...
          return (
            o()
              ...
              ? (r.type = "webworker")
              : "object" === (void 0 === t ? "undefined" : n(t)) && (r.type = "node"),
            void 0 === e ? r : r[e]
          );
        };
      }.call(this, r(2)));
    ...
    function (e, t, r) {
      (function (t) {
        ...
        e.exports = function () {
          return (
            ("undefined" != typeof window && "object" === r(window.process) && "renderer" === window.process.type) ||
            !(void 0 === t || "object" !== r(t.versions) || !t.versions.electron) ||
            ("object" === ("undefined" == typeof navigator ? "undefined" : r(navigator)) && "string" == typeof navigator.userAgent && navigator.userAgent.indexOf("Electron") >= 0)
          );
        };
      }.call(this, r(2)));
    },
              ...
              t.lines.forEach(function (r) {
                r.words.forEach(function (o) {
                  o.symbols.forEach(function (i) {
                    a.push(n({}, i, { page: e, block: c, paragraph: t, line: r, word: o }));
                  }),
                    i.push(n({}, o, { page: e, block: c, paragraph: t, line: r }));
                }),
    ...
    function (e, t, r) {
      var n = r(17),
        ...
        c = r(23),
        u = r(24);
      e.exports = { defaultOptions: n, spawnWorker: o, terminateWorker: i, onMessage: a, send: c, loadImage: u };
    },
    function (e, t, r) {
      (function (t) {
        function n(e) {
        ...
        e.exports = (function (e) {
          ...
          workerPath:
            void 0 !== t && "development" === t.env.TESS_ENV
              ? a("/dist/worker.dev.js?nocache=".concat(Math.random().toString(36).slice(3)))
              : "https://unpkg.com/tesseract.js@v".concat(u, "/dist/worker.min.js"),
          corePath: "https://unpkg.com/tesseract.js-core@v"
            .concat(s["tesseract.js-core"].substring(1), "/tesseract-core.")
            .concat("object" === ("undefined" == typeof WebAssembly ? "undefined" : n(WebAssembly)) ? "wasm" : "asm", ".js"),
        });
      }.call(this, r(2)));
    },
    function (e) {
    ...
    function (e, t) {
      e.exports = { langPath: "https://tessdata.projectnaptha.com/4.0.0", workerBlobURL: !0, logger: function () {} };
    },
    function (e, t) {
      e.exports = function (e) {
        var t,
